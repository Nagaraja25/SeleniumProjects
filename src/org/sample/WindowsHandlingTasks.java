...
public class WindowsHandlingTasks {
	...
	public static void main(String[] args) throws AWTException, InterruptedException {
		...
		//
		//
		// WebElement iphone = driver.findElement(By.xpath("//span[text()='iPhone X
		// (64GB, Space Gray) [Locked] + Carrier Subscription']"));
		//
		...
		WebElement iphone7 = driver.findElement(By.xpath(
				"//p[@title='Apple Iphone 7 Plus Bumper Cases Kosher Traders - Transparent Premium Transparent Case']"));
		iphone7.click();
		...
		// WebElement cart = driver.findElement(By.xpath("//span[text()='add to
		// cart']"));
		// cart.click();
